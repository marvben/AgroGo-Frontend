...
export const fetchManyProducts = ({ property, newOrder, id, limit, cursor }) => {
...
export const updateProduct = (productId, formData) => API.patch(`/api/products/${productId}`, formData);

export const deleteProduct = ({ userId, productId }) => API.delete(`/api/products/${productId}`, { data: { userId } });
